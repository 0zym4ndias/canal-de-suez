...
// * Struct para la LLque guardara el .txt file
struct registro
{
    string fecha;
    string mes;
...
// * Struct para el vector que guardara las entradas x mes
struct registroVect
{
    string mes;
    string year;
...
{
    // Instrucciones
    os << otra.triple << " " << otra.ubi << " " << otra.fecha << " "  << otra.hora << " " << otra.entrada << endl;
    return os;
}
