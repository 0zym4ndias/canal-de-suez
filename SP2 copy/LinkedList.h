...
public:
    ...
    string searchM(const LinkedList<T> listaM, string ubi);
    string searchR(const LinkedList<T> listaR, string ubi);

    // * Atributos privados
private:
    Node<T> *head;
    int size;
    vector<registroVect> vector1;
};
...
template <class T>
string LinkedList<T>::searchM(const LinkedList<T> listaM, string ubi){

    Node<T> *curr = listaM.head;
...
template <class T>
string LinkedList<T>::searchR(const LinkedList<T> listaR, string ubi){
